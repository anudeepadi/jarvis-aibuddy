...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-screen bg-[#0d0d0d] flex flex-col items-center justify-center p-4">
      {/* Ambient glow effect */}
      ...
      <div className="relative z-10 flex flex-col items-center gap-8 max-w-md w-full">
        ...
        {/* Sign in card */}
        <div className="w-full p-8 rounded-2xl bg-gradient-to-b from-gray-900/50 to-gray-900/30 border border-gray-800/50 backdrop-blur-sm">
        ...
        {/* Footer */}
        <p className="text-gray-600 text-xs">
          Powered by Groq, Cartesia & OpenAI
        </p>
      </div>
    </main>
  )
